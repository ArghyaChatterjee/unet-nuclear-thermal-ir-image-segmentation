...
- In this work, we employed a semi-automatic strategy for training data segmentation. The successive image processing steps described in section 3.4.2 generates false positives and false negatives in the segmentation map that could severely affect the results when testing the network. 
